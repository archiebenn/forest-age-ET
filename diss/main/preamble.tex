...
% headers and section numbering
\setcounter{secnumdepth}{1}   % only \section gets a number, subsections won't
\setcounter{tocdepth}{1} 
\renewcommand{\subsectionmark}[1]{} % only sections in headers, no deeper
