...
\read\wcfile to \wordcountresult
\closein\wcfile
...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\vspace{1em}
	\noindent\textbf{Word count:} \wordcountresult 
	\vspace*{\fill}
...
I would like to thank my supervisor Professor Martin de Kauwe for his help and guidance throughout the duration of this project.
