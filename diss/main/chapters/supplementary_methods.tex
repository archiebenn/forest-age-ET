...
\begin{table}[H]
	\caption{\centering Features and definitions included in RF models during training and inference.}
	\centering
	\rowcolors{2}{white}{gray!7}
