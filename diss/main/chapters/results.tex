...
\begin{figure}[H]
	...
	\captionsetup{justification=centering}
	\caption{Heatmap of cluster medoid sites and scaled feature values. Scaled features $\geq$ 1.5 standard deviations from the mean were classed as 'very' (high or low, depending on direction), while features between 1 and 1.5 standard deviations from the mean were classed as high or low, depending on direction, in order to characterise clusters.}
	\label{fig:pheat}
\end{figure}
