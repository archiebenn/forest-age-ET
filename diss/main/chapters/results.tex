...
\autoref{fig:paired_box} shows the paired results between the `Mod' (described by \autoref{eqn:mod}) and the `Mod + Age' (described by \autoref{eqn:mod_age}) models during the shuffled training set analysis (see section \ref{sec:shuffle} for details). 
